import pygame
from settingsGame.settings_game import GameSettings, BackForest, Tiles, world_data1, Player_Sprites, Enemy_Sprites, Items, Sounds
import os
import math
...
class Level1:
    ...
    def __init__(self, game):
        ...
        # Carregando as camadas do fundo paralax
        self.bg_layers = []
        for i in range(1, 8):
        ...
        # Carregando tiles
        self.dirt_img = pygame.image.load(Tiles["dirt"]).convert_alpha()
        self.grass_img = pygame.image.load(Tiles["grass"]).convert_alpha()
        ...
        # Calcula os limites do mundo baseado na matriz
        self.world_width = len(world_data1[0]) * GameSettings["TILE_SIZE"]
        self.world_height = len(world_data1) * GameSettings["TILE_SIZE"]
        ...
        for y, row in enumerate(world_data1):
    ...
    def draw_background(self):
        # Desenha o fundo considerando os limites do mundo
        for i, layer in enumerate(self.bg_layers):
            parallax = (i + 1) * 0.1
            x = -min(self.camera_x * parallax, 
                self.world_width - GameSettings["WINDOW_WIDTH"])
        ...
        for tile in self.tile_list:
            ...
            if (-tile[1].width <= screen_x <= GameSettings["WINDOW_WIDTH"] and
                ...
                #pygame.draw.rect(self.screen, (255, 255, 255), 
                               #(screen_x, screen_y, tile[1].width, tile[1].height), #2)
